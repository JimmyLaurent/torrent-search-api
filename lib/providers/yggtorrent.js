...
class Yggtorrent extends TorrentProvider {
  constructor() {
    super({
      ...
      searchUrl: '/engine/search?name={query}&do=search&order=desc&sort=seed&category={cat}',
      categories: {
        All: '',
        Videos: '2145',
  ...
  isLogged() {
    return super.isLogged() && this.lastLoginTime && Date.now() - this.lastLoginTime < 600000;
  }
