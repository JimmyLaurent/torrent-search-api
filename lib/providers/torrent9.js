...
class Torrent9 extends TorrentProvider {
  constructor() {
    super({
      ...
      categories: {
        All: '',
        Movies: 'url:/search_torrent/films',
        TV: 'url:/search_torrent/series',
        Music: 'url:/search_torrent/musique',
        Apps: 'url:/search_torrent/logiciels',
        Books: 'url:/search_torrent/ebook',
        Top100: 'url:/top'
      },
      defaultCategory: 'All',
